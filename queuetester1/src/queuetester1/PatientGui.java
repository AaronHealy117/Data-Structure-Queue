...
System.exit(0);        // TODO add your handling code here:
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        p.setSym(jTextField2.getText());
        MyPatient.enqueue(p);
        
        jTextArea1.append(p.getName() + " was added to the list!!" + "\n");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        jTextArea1.append("There are " + MyPatient.size() + " customers in the queue!" + "\n" );
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if(!MyPatient.isEmpty()){
            Patient p = (Patient) MyPatient.dequeue();
            
            
            jTextArea1.append(p.getName() + " is next!" + "\n");
            jTextArea1.append("Symptoms are: " + p.getSym() + "\n");
        }
        else{
            jTextArea1.append("there are no more customers");
        }
